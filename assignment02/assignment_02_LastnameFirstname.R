...
setwd("/Users/dancl/OneDrive/Documents/GitHub/dsc520/data/tidynomicon")
...
voter_turnout_df2 <- read_excel("../G04ResultsDetail2004-11-02.xls","Voter Turnout",col_names = c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout"), skip = 2)
